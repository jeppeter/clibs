...
WINLIB_API int complete_namedpipe_rdpending(void* pnp);
WINLIB_API int complete_namedpipe_wrpending(void* pnp);
WINLIB_API int complete_namedpipe_connpending(void* pnp);
